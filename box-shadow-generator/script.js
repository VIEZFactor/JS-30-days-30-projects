...
sliders.forEach(
    (slider) => slider.addEventListener("input", generateShadow)
);
...
function createBoxShadow(
    ...
    return `${hShadow}px ${vShadow}px ${blurRadius}px ${spreadRadius}px ${rgbaColor} ${shadow} `;
}

function hexToRgba(color, opacity){
    // This will get color in hexadecimal
