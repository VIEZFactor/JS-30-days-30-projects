...
function calculateAge(){
    ...
    // In the birthMonth we substract one month because month 0 is January and month 11 is December
    const birthMonth = parseInt(birthdateParts[1]) - 1;
    const birthYear = parseInt(birthdateParts[2]);
    const birthDate = new Date(birthYear, birthMonth, birthDay);

    // Checking if the inputed date is really a date
    ...
    console.log({birthDay, birthMonth, birthYear, birthDate});
}