...
function updateInvestmentValue(value){
    document.getElementById("investment-value").innerText = `$${parseFloat(value)}`;
}

function updateInterestRateValue(value){
    document.getElementById("interest-rate-value").innerText = `${parseFloat(value)}%`;
}

function updateTimePeriodValue(value){
    document.getElementById("time-period-value").innerText = `${parseFloat(value)}`;
}
...
function calculateFD(){
    ...
    document.getElementById("invested-amount").innerText = `$${principal}`;
    document.getElementById("estimated-returns").innerText = `$${Math.round(interestEarned)}`;
    document.getElementById("total-value").innerText = `$${Math.round(totalAmount)}`;
}